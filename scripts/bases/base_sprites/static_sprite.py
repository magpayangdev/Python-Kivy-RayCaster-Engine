...
class StaticSprite(SceneSprite):
	def __init__(self, game, sprite_id='candle_bra', minimap_icon='cherry.png', world_pos=(100,100), radius=0.1, scale=0.5, health=10, influence_range=1, influence_amount=1, hide=False):
	
		super().__init__(game=game, sprite_id=sprite_id, minimap_icon=minimap_icon, initial_mode='idle', color=(1,1,1,1), world_pos=world_pos, scale=scale, hide=hide, flip_time=999, start_iter=False, speed=0, health=health, radius=radius, influence_amount=influence_amount, influence_range=influence_range)
